...
const seedData = async () => {
    try {
        ...
        // Create Users
        // Primary accounts with different passwords for testing different scenarios
        ...
        console.log('   👨‍🎓 Student: student@campushub.edu / student123');
        console.log('   👨‍🏫 Faculty: faculty@campus.edu / password123');
        console.log('   🔑 Admin: admin@campushub.edu / admin123');
        console.log('   👔 Coordinator: coordinator@campus.edu / password123');
        console.log('   🎯 Alumni: alumni@campushub.edu / password123');
